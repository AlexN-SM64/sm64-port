# JP/EU/SH/CN Font texture format fix (not only for PC)
ifeq ($(TARGET_N64),0)

# JP/SH font texture format fix
...
# CN font texture format fix
$(BUILD_DIR)/$(TEXTURE_DIR)/segment2/segment2_cn.%.ia1.inc.c: $(TEXTURE_DIR)/segment2/segment2_cn.%.ia1.png
	$(call print,Converting to IA4:,$<,$@)
	$(V)$(N64GRAPHICS) -s $(TEXTURE_ENCODING) -i $@ -g $< -f ia4
