...
const Gfx burn_smoke_seg4_dl_04022070[] = {
    ...
    gsDPLoadTextureBlock(burn_smoke_seg4_texture_04021800, FIX_G_IM_FMT_RGBA_TO_IA, G_IM_SIZ_16b, 32, 32, 0, G_TX_CLAMP, G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
